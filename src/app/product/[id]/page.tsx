...
//         <Image src={product.img} alt={product.name} width={700} height={500} />
//       </div>
//       <div className="w-full lg:w-1/2">
//         <h1 className="text-4xl font-bold">{product.name}</h1>
//         <p className="text-gray-600 mt-4">{product.description}</p>
//         <h2 className="text-2xl text-green-600 mt-4">Rs. {product.price}</h2>
//         <button
...
<section className="text-gray-600 body-font overflow-hidden">
  <div className="container px-5 py-24 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <Image alt="ecomm" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src={product.img} width={300} height={300}/>
